...
router.get('/tweets/add', auth.hasTweetAccess, (req, res) => {
  res.render('views/add_tweet');
});

router.post('/tweets/add', auth.hasTweetAccess, async (req, res) => {
  await tweetsCtrl.create(req, res);
  res.redirect('/tweets')
});

router.post('/tweets_custom/add', auth.hasTweetAccess, async (req, res) => {
  await tweetsCtrl.create(req, res);
...
router.post('/tweets_custom/delete', auth.hasTweetAccess, (req, res) => {
...
router.post('/tweets/delete', auth.hasTweetAccess, (req, res) => {
